...
public class BleService extends Service {
	...
	public static final UUID Service_water = UUID.fromString("f0001140-0451-4000-b000-000000000000");
	public static final UUID water = UUID.fromString("f0001141-0451-4000-b000-000000000000");

	public static final UUID RX_SERVICE_UUID = UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb");// DE5BF728-D711-4E47-AF26-65E3012A5DC7
	...
	public static final UUID RX_CHAR_UUID = UUID.fromString("00002A06-0000-1000-8000-00805f9b34fb");// DE5BF729-D711-4E47-AF26-65E3012A5DC7
	public static final UUID TX_CHAR_UUID = UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb");// DE5BF72A-D711-4E47-AF26-65E3012A5DC7
	...
	private void getChartacteristicValue(
		...
		mIntent.putExtra("charUUID",characteristic.getUuid());
		mIntent.putExtra("HexValue", hexValue);
		mIntent.putExtra("time", DateUtil.getCurrentDatatime());
		sendBroadcast(mIntent);

		//Команда вывода на экран активности_характеристики текущее значение счетчика воды
		if (mBluetoothGatt != null) {
			new Thread(new Runnable() {
				@Override
				public void run() {
					...
					try {
						...
						BluetoothGattCharacteristic gattChar = mBluetoothGatt.getService(Service_water).getCharacteristic(water);
	...
	public boolean connect(String bleAddress) {
		...
		if (mBluetoothAdapter == null || bleAddress == null) {
			Log.w(TAG,
					"BLE адаптер не включен или неправильный адрес.");
			return false;
		}
