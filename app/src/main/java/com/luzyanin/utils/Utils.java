...
public class Utils {
	...
	static {
		attributes.put("f0001140-0451-4000-b000-000000000000", "Учет воды");
		attributes.put("f0001141-0451-4000-b000-000000000000", "Показания счетчика холодной воды");
		attributes.put("f0001142-0451-4000-b000-000000000000", "Коэффициент");
		attributes.put("f0001143-0451-4000-b000-000000000000", "Архивы");
		attributes.put("f000114f-0451-4000-b000-000000000000", "Синхронизация времени с BLE устройством");
